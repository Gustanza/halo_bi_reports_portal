                    ...
                    <table>
                        ...
                        <tbody>
                            <tr v-for="(user, index) in users" :key="index">
                                ...
                                <td>
                                    <a :href="`tel:${user.phoneNumber}`" class="link">{{ user.phoneNumber }}</a>
                                </td>
                                <td>
            ...
            <div class="modal-content" @click.stop>
                ...
                <form @submit.prevent="handleSubmit" class="modal-form">
                    <div class="form-group">
                        ...
                        <input id="fullName" v-model="formData.fullName" type="text" placeholder="Enter full name"
                            required />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-hint">Enter phone number with country code (e.g., +255 123 456 789)</small>
                    </div>
...
const handleSubmit = () => {
    ...
    // const normalizedEmail = formData.value.email.toLowerCase().trim();

    // if (isEditMode.value && editingIndex.value !== null) {
    //     // Check if email already exists (excluding current user)
    //     const emailExists = users.value.some(
    //         (user, idx) => user.email === normalizedEmail && idx !== editingIndex.value
    //     );
    //     if (emailExists) {
